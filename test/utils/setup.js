...
const fourHoursFraction3CM = new Date((admin.firestore.Timestamp.now()._seconds - 17101) * 1000);
const dayCM = new Date((admin.firestore.Timestamp.now()._seconds - 18001) * 1000);
const dayFractionCM = new Date((admin.firestore.Timestamp.now()._seconds - 86402) * 1000);
const halfHourPlusCM = new Date((admin.firestore.Timestamp.now()._seconds - 1861) * 1000);
    ...
    db.collection("headquarters").doc("kPlPR3Rysv3uCsrUdcn2").set({
        ...
        reservations: [
            ...
            },
            {
                cash: 0,
                change: 0,
                dateStart: fourHoursFraction3CM,
                hqId: 'kPlPR3Rysv3uCsrUdcn2',
                officialEmail: 'funcionario@zonap.test',
                phone: '+563017792134',
                plate: 'HOO33X',
